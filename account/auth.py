...
from .web_auth.data import PROD_PUBLIC_KEY
from .web_auth.data import TEST_PUBLIC_KEY
from .web_auth.data import WebAppChat
from .web_auth.data import WebAppInitData
from .web_auth.data import WebAppUser
from .web_auth.errors import ExpiredInitDataError
from .web_auth.errors import InvalidInitDataError
...
class TelegramAuthenticator:
    ...
    def _validate(self, hash_: str, init_data: str) -> bool:
        ...
        client_hash = hmac.new(
            self._secret, init_data_bytes, hashlib.sha256
        ).hexdigest()
    ...
    def __serialize_init_data(
        self, init_data_dict: typing.Dict[str, typing.Any]
    ) -> WebAppInitData:
    ...
    def validate_third_party(
        ...
        if not self.__ed25519_verify(
            public_key, signature_bytes, data_check_string_bytes
        ):
